"""FastAPI dependency injection for the Partnership bounded context.

Provides:
- ``get_partnership_uow``: yields a SqlAlchemyUnitOfWork for partnership.
...
def get_partnership_uow() -> Generator[SqlAlchemyUnitOfWork, None, None]:
    """FastAPI dependency that yields a SqlAlchemyUnitOfWork for partnership.
