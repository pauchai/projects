/**
 * Project settings — Applications sub-page.
 *
 * Adapted from manage-applications.tsx for the workspace settings tab.
 */
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <div className="text-sm text-muted-foreground">
              Desired role:{" "}
              <span className="text-foreground">{application.desired_role}</span>
            </div>
